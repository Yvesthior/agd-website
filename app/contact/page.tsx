...
const heroImages = [
  { src: "/images/header1.jpg", alt: "Contact Génération David - Image 1" },
  { src: "/images/header2.jpg", alt: "Contact Génération David - Image 2" },
  { src: "/images/header3.jpg", alt: "Contact Génération David - Image 3" },
  { src: "/images/header4.jpg", alt: "Contact Génération David - Image 4" },
];
              ...
              <div className="space-y-8">
                  ...
                  <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-start space-x-2">
                        ...
                        <span className="text-gray-600">
                          cotedivoire@generationdavid.org
                        </span>
                      </div>
                      <div className="flex items-start space-x-2">
                ...
                <div className="bg-sky-50 rounded-xl p-6">
                  ...
                  <p className="text-gray-700">
                    Notre équipe est disponible pour vous répondre du lundi au
                    vendredi, de 9h à 18h (heure locale).
                  </p>
                </div>
              </div>
            </div>
